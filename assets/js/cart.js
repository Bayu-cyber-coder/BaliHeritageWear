...
function updateCheckoutTotal() {
  ...
  if (subtotalEl) subtotalEl.innerText = "Rp" + formatRupiah(checkoutSubtotal);
  if (ongkirEl) ongkirEl.innerText = "Rp" + formatRupiah(checkoutOngkir);
  if (totalEl) totalEl.innerText = "Rp" + formatRupiah(checkoutSubtotal + checkoutOngkir);
}
...
async function renderCheckoutSummary() {
  ...
  tbody.innerHTML = cart.map(item => {
    ...
    return `
      <tr>
        <td>${escapeHtml(prod.name)} x${qty}</td>
